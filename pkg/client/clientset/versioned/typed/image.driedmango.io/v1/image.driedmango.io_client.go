...
import (
	...
	"github.com/driedmango520/kube-container-image/pkg/client/clientset/versioned/scheme"
...
// ImageV1Client is used to interact with features provided by the image.driedmango.io group.
type ImageV1Client struct {
	restClient rest.Interface
}

func (c *ImageV1Client) ImageBuilds(namespace string) ImageBuildInterface {
