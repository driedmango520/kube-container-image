...
import (
	...
	scheme "github.com/driedmango520/kube-container-image/pkg/client/clientset/versioned/scheme"
...
func newImageBuilds(c *ImageV1Client, namespace string) *imageBuilds {
	return &imageBuilds{
		client: c.RESTClient(),
		ns:     namespace,
	}
